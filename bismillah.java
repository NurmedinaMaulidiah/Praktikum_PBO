...
public class bismillah {
    ...
    public static void read() throws IOException{
        System.out.println("\n=============== DATA PEMESANAN KAMAR HOTEL DEL LUNA ===============");
        ...
        for (int i = 0; i < pemesan.size(); i++){
            ...
            System.out.println(" Nama Pemesan             : " + pemesan.get(i).getNama());
            System.out.println(" No Hp Pemesan            : " + pemesan.get(i).getNoHp());
            System.out.println(" Jenis Kamar yang dipesan : " + pemesan.get(i).getJenisKamar());
            System.out.println(" Harga Kamar yang dipesam : " + pemesan.get(i).getHargaKamar());
            System.out.println(" Lama Inap                : " + pemesan.get(i).getLamaInap());
            System.out.println(" Total Harga              : " + pemesan.get(i).getTotalHarga());
            System.out.println("\n");
    ...
    public static void update() throws IOException{
        ...
        System.out.print("Masukkan Nama Pemesan Kamar      : ");
        String addNama = br.readLine();
        pemesan.get(index-1).setNama(addNama);
        System.out.print("Masukkan No Hp Pemesan           : ");
        int addNoHp = Integer.parseInt(br.readLine());
        pemesan.get(index-1).setNoHp(addNoHp);
        ...
        int lamaInap = Integer.parseInt(br.readLine());
        pemesan.get(index-1).setLamaInap(lamaInap);
        // System.out.println("Masukkan Total Harga            : ");
        double totalHarga = lamaInap * setHargaKamar;
        pemesan.get(index-1).setTotalHarga(totalHarga);
